...
public class GameCharacterMenu {
	...
	characterNameDAO cnd = new characterNameDAO();
	...
	private void createCharacterName() throws SQLException {
		String firstName = null;
		String lastName = null;
		String choice = scanner.nextLine();
		System.out.println("Create your Characters Name");
		System.out.println("1) Type First Name");
		firstName = scanner.nextLine();
		System.out.println("2) Type Last Name");
		lastName = scanner.nextLine();
		cnd.createCharacterName(firstName, lastName);
	...
	private void showCharacterName() throws SQLException {
		List<CharacterName> characterNames = characterNameDAO.getCharacterName();
		characterNames.stream().forEach(System.out::println);
